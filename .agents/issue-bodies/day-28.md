...
_Live architecture discussion. Holding technical lines under pressure._

Write `course/day-28-rehearse-engineer/README.md` — a 45–60 minute teaching document that takes a
...
**Owns:** **Reuses W1–3.** Live architecture discussion, "design an AI solution for customer X", holding technical lines, admitting what you don't know
...
### Day 28 — Rehearse (engineer audience)
Reuse the Anthropic engineering essays. Rehearse architecture, decisions, failures, tradeoffs. Expect a live architecture discussion and "design an AI solution for customer X" scenario.
