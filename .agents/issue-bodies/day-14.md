...
_Synthesis. Rehearse “what happens when it fails halfway through?”_

Write `course/day-14-week-2-checkpoint/README.md` — a 45–60 minute teaching document that takes a
...
**Owns:** **Synthesis day.** Reliability story end-to-end; rehearse "what happens when it fails halfway through?"
...
### Day 14 — Checkpoint
Consolidate: resumable agent + structured outputs + state recovery + explicit failure behavior.
