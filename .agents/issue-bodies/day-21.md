...
_Synthesis. Rehearse “how do you know it's working, and what does it cost?”_

Write `course/day-21-week-3-checkpoint/README.md` — a 45–60 minute teaching document that takes a
...
**Owns:** **Synthesis day.** The measurement + economics story; rehearse "how do you know it's working?" and "what does it cost?"
...
### Day 21 — Checkpoint
Consolidate: evaluated agent + known failure modes + measured cost + golden dataset.
