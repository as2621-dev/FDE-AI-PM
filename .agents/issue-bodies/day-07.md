...
_Synthesis. Rehearse “walk me through your agent.”_

Write `course/day-07-week-1-checkpoint/README.md` — a 45–60 minute teaching document that takes a
...
**Owns:** **Synthesis day.** No new concepts. Assemble D1–6 into one story, drill the connections, rehearse "walk me through your agent"

**Must NOT cover:** Anything not already taught in D1–6
...
### Day 7 — Checkpoint
Consolidate: working agent + two tools + guardrails + deliberate memory + full audit trail. Write a README documenting *why* each component exists (this becomes raw material for Day 24).
